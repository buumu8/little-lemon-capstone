const BookingForm = ({ handleChange, formSubmit, availableTimes }) => {
  return (
    <section>
      <h1>Reservation</h1>
      <section className="bookingForm">
        <form className="bookingForm-form" onSubmit={formSubmit}>
          <label htmlFor="res-date" data-testid="Oshop">
            Choose date
          </label>
          <input type="date" id="res-date" data-testid="res-date" name="date" onChange={(e) => handleChange(e)} />
